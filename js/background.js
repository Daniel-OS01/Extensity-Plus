...
(function(root) {
  ...
  function normalizeExtensions(items, state) {
    ...
    // ⚡ Bolt: Pre-compute Sets and Maps for O(1) lookups instead of O(N) Array.prototype.indexOf() inside the loop.
    ...
    return items.slice().sort(function(left, right) {
      ...
      // ⚡ Bolt: Cache recent list index to prevent redundant map lookups.
      ...
      return {
        ...
        lastUsed: recentIndex === -1 ? 0 : (recentListLength - recentIndex),
