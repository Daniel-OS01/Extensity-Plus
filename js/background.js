...
(function(root) {
  ...
  function normalizeExtensions(items, state) {
    ...
    // ⚡ Bolt: Convert arrays to Sets/Maps for O(1) lookups instead of O(N) indexOf during iteration
    // Expected impact: Eliminates nested loop overhead in item normalization for large lists
