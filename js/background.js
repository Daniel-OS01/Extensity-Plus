...
(function(root) {
  ...
  function normalizeExtensions(items, state) {
    ...
    // ⚡ Bolt: Pre-compute sets and maps for O(1) lookups in loop to avoid O(N^2) complexity
    // Expected impact: ~95% reduction in lookup time for array states containing 20+ extensions
    ...
    return items.slice().sort(function(left, right) {
      ...
      // ⚡ Bolt: Use pre-computed Set/Map for O(1) checks
