...
(function(root) {
  ...
  function normalizeExtensions(items, state) {
    ...
    // Performance optimization: Pre-compute Sets for O(1) membership lookups
    // and a Map for recentList indices to replace O(N) Array.prototype.indexOf
    // calls inside the items.map() iteration loop.
