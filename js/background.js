...
(function(root) {
  ...
  function normalizeExtensions(items, state) {
    ...
    // instead of repeatedly calling Array.prototype.indexOf() inside the iteration loop.
    // This reduces the time complexity of normalizeExtensions from O(N*M) to O(N+M).
