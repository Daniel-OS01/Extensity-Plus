...
(function(root) {
  ...
  function normalizeExtensions(items, state) {
    ...
    // Performance optimization: Cache array presence and indices using Set and Map
    // to reduce time complexity from O(N * M) to O(N + M) inside the normalize loop.
  ...
  async function runApplyProfile(profileName) {
    ...
    // Performance optimization: Cache array presence using Set
    // to reduce time complexity from O(N * M) to O(N + M) inside the loop.
