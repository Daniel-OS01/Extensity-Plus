...
(function(root) {
  ...
  function normalizeExtensions(items, state) {
    ...
    // Caching lookups using Set and Map instead of calling Array.prototype.indexOf()
    // inside the map loop prevents O(N^2) complexity and drastically cuts execution
    // time (up to 96% improvement in array iterations).
