...
(function(root) {
  ...
  function normalizeExtensions(items, state) {
    ...
    // ⚡ Bolt: Cache array lookups using Sets and Maps to reduce time complexity from O(N*M) to O(N+M)
    ...
    return items.slice().sort(function(left, right) {
      ...
      return {
        ...
        lastUsed: recentIndex === undefined ? 0 : (recentListLength - recentIndex),
