...
(function(root) {
  ...
  function normalizeExtensions(items, state) {
    ...
    // Replace O(N) indexOf lookups with O(1) Set and Map lookups to improve normalizeExtensions mapping iteration time.
  ...
  async function runApplyProfile(profileName) {
    ...
    // ⚡ Bolt: Performance optimization
    // Pre-compute Set for O(1) desiredIds lookup
